#!/bin/bash
# zinstance/src/bika.custom/bika/custom/locales
ZINSTANCE=$PWD'/../../../../..'
...
# smash bika-manual into bika.custom output,
...
$I18NDUDE sync --pot bika.custom.pot */LC_MESSAGES/bika.custom.po
